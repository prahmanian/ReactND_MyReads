...
class StarterBooksApp extends React.Component {
    state = {
      /**
    ...
    componentDidMount() {
        const result = BooksAPI.getAll().then((result) => (console.log('result', result))) //Fixed this line from starter code
        console.log('static mount' , result)
...
export default StarterBooksApp